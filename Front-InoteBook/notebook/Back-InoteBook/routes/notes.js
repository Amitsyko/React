...
// ROUTE 1: Get all the notes with auth-token Id using GET "api/auth/fetchallnotes". Login Required
...
// ROUTE 4: Delete Existing note using DELETE "api/note/deletenotes". Login Required--
