...
export default function Notes(props) {
    ...
    const handelOnClick = (e) => {
        ...
        props.showAlert("Noters Updated SuccessFully", "success")
    }
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={ note.etitle.length<5 || note.edescription.length<5 } type="button" className="btn btn-primary" onClick={handelOnClick}>Update Note</button>
                        </div>
                    </div>
                </div>
            </div>
